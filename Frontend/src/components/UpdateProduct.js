...
export default function InsertProduct() {
    ...
    const updateProduct = async (e) => {
        ...
        if (!productName || !productPrice || !productBarcode || !productBrands) {
        ...
        try {
            const response = await fetch(`http://localhost:3001/updateproduct/${id}`, {
                ...
                body: JSON.stringify({ "ProductName": productName, "ProductPrice": productPrice, "ProductBarcode": productBarcode, "ProductBrands": productBrands })
            });
    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12">
                <label htmlFor="product_brands" className="form-label fs-4 fw-bold">Product Brands</label>
                <input type="text" onChange={setBrands} value={productBrands} className="form-control fs-5" id="product_brands" placeholder="Enter Product Brand" required />
            </div>
