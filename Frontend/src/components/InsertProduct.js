...
export default function InsertProduct() {
    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12 fs-4">
                <label htmlFor="product_brands" className="form-label fw-bold">Product Brands (Separate by commas)</label>
                <textarea onChange={setBrands} value={productBrands} className="form-control fs-5" id="product_brands" placeholder="Enter Product Brands" required />
            </div>
